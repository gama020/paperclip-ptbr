    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <span className="text-sm text-muted-foreground">{t("agent.add_new_agent")}</span>
          <Button
            variant="ghost"
            size="icon-xs"
          ...
          {!showAdvancedCards ? (
            <>
              ...
              <div className="text-center">
                ...
                >
                  {t("agent.advanced_config_myself")}
                </button>
              </div>
            </>
          ) : (
            <>
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  {t("agent.choose_adapter_advanced")}
                </p>
              </div>
